...
<?php endif; ?>
        ...
        <ul class="nav-top span5">
		  ...
		  foreach($main_menu as $link){
			echo '<li><a href="'.$base_path.$link['href'].'">'.$link['title'].'</a></li>';
		  }
		  ?>
        </ul>
        <div class="header-search span3">
		 ...
		 <script type="text/javascript">window.onload = function (){ 
			document.getElementById('edit-search-block-form--2').value = "Search..."; 
			document.getElementById('edit-search-block-form--2').onclick = function () { 
				if(document.getElementById('edit-search-block-form--2').value == "Search..."){
  ...
  <div class="row">
    <div class="span9">
      <div class="main-content">	  
	    <?php if(!is_array($page['sidebar_second']['menu_menu-main-menu-right'])){ ?>
			<h3 class="content-type"><?php print render($page['blacktab']); ?></h3>
		<?php } ?>	
        <div class="header"><h1><?php if ($title): print $title; endif; ?></h1></div>     
	...
	<?php if(is_array($page['sidebar_second']['menu_menu-main-menu-right'])){ ?>
      <div class="sidebar">
		  <div class="sidebar-unit"><h4 class="side-head">ALL CATEGORIES</h4>	
	  ...
	  <?php } else { 
	  	if(!empty($page['newpage_sidebar'])){ ?>
	  <div class="sidebar">
		  <div class="sidebar-unit">
		  <h4 class="side-head">NEED MORE INFO</h4>	
			<div class="sidebar-content">
			   <?php print render($page['newpage_sidebar']); ?>
			</div>
		  </div>
		  <div class="sidebar-unit">
		  <h4 class="side-head">RELATED TOPICS</h4>
			  <div class="sidebar-content">
			   <?php print render($page['newpage_sidebottom']); ?>
			  </div>
		  </div>	  
	  </div>	  
	  <?php } } ?>
